...
const DropdownMenuContainer = () => {
  return (
    ...
    >
      <Box css={{ position: 'relative', zIndex: '1', backgroundColor: '$gray800', height: 4, width: '25%', mt: 8, mb: 16, mx: '$4' }}></Box>
      <Box css={{ position: 'relative', zIndex: '1', backgroundColor: '$gray800', height: 4, width: '50%', mb: 16, mx: '$4' }}></Box>
      <Box css={{ position: 'relative', zIndex: '1', backgroundColor: '$gray800', height: 4, width: '25%', mb: 16, mx: '$4' }}></Box>
      <Box css={{ position: 'relative', zIndex: '1', backgroundColor: '$gray800', height: 4, width: '50%', mb: 16, mx: '$4' }}></Box>
      <Box css={{ position: 'relative', zIndex: '1', backgroundColor: '$gray800', height: 4, width: '25%', mb: 8, mx: '$4' }}></Box>
      <Box
        css={{
          position: 'absolute',
          top: 5,
