import type {
  ...
  AutocompleteCollection as InternalAutocompleteCollection,
...
export type AutocompleteCollection = InternalAutocompleteCollection<DocSearchHit>;
export type AutocompleteState = InternalAutocompleteState<DocSearchHit>;
