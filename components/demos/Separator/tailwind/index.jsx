...
const SeparatorDemo = () => (
  <div className="mx-[15px] w-full max-w-[300px]">
    <div className="text-[15px] font-medium leading-5 text-white">Radix Primitives</div>
    <div className="text-[15px] leading-5 text-white">An open-source UI component library.</div>
