  ...
  return (
    <MobileMenuProvider>
      <div className={styles.root}>
        ...
        <Flex direction="column" gap="9" m={{ initial: '3', md: '6', xl: '9' }}>
          <ComponentWrapper>
            <Flex align="baseline" gap="4" mt="2">
              ...
              <NextLink passHref href="/themes/docs/components/alert-dialog">
                <Link className={styles.ViewDocsLink} size="2">
                  View in docs
                </Link>
              </NextLink>
            </Flex>
          ...
          <ComponentWrapper>
            ...
            <Box style={{ width: 'calc(580px * var(--scaling))' }}>
              ...
              the 1960s, when it was popularized by advertisements for Letraset transfer sheets. It
              is typically a corrupted version of <Em>De finibus bonorum et malorum</Em>,
...
const ComponentWrapper: React.FC<React.PropsWithChildren<unknown>> = ({ children }) => (
  <Flex className={styles.ComponentWrapper} direction="column" gap="5" mb="8">
    {children}
  </Flex>
);
