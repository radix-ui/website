      ...
      <div className={styles.root}>
        ...
        <Box m={{ initial: '3', md: '6', xl: '9' }}>
          ...
          <Box mb="9" style={{ width: 'calc(580px * var(--scaling))' }}>
            Versions of the <Em>Lorem ipsum</Em> text have been used in typesetting at least since
            the 1960s, when it was popularized by advertisements for Letraset transfer sheets. It is
            typically a corrupted version of <Em>De finibus bonorum et malorum</Em>, a 1st-century
            ...
            <TabsContent value="specimen">
              ...
              >
                <Flex direction="column" gap="6">
                  ...
                  <Text as="p" size="4">
                    Susan Kare is an American artist and <Link href="#link">graphic designer</Link>,
                    who contributed <Link href="#link">interface</Link> elements and{' '}
                    ...
                    <Box pr="5">
                      <Flex direction="column" gap="4">
                        ...
                        <Text as="p" size="2">
                          ...
                          decipherable and recognisable”. For instance, if a “b” and an “h”, or a
                          “3” and an “8”, are difficult to distinguish at small sizes, this is a
