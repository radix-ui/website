...
title: Toggle Group
name: toggle-group
description: A set of two-state button that can be toggled on or off.
...
Contains all the part of a toggle group.
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          rendered (when <Code>type</Code> is <Code>"single"</Code>).
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          rendered (when <Code>type</Code> is <Code>"multiple"</Code>
          ). Use when you do not need to control the state of the items.
        </span>
      ),
    },
