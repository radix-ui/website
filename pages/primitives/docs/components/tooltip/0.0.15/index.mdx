...
Use the `delayDuration` to control the time it takes for the tooltip to open. You can define these per-instance, but it is best to set a default value for the prop so all your tooltips use the same timings.
