...
render(
  <AccordionPrimitive>
    <AccordionItem value="item-1">
      ...
      <AccordionPanel>
        <p>Here goes the content for the accordion item 1.</p>
      </AccordionPanel>
    </AccordionItem>
    ...
    <AccordionItem value="item-2">
      ...
      <AccordionPanel>
        <p>Here goes the content for the accordion item 2.</p>
      </AccordionPanel>
    </AccordionItem>
    ...
    <AccordionItem value="item-3">
      ...
      <AccordionPanel>
        <p>Here goes the content for the accordion item 3.</p>
      </AccordionPanel>
    </AccordionItem>
  </AccordionPrimitive>
);
