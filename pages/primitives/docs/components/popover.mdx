...
For this, we expose a CSS custom property called `--radix-popover-content-transform-origin` which you can use this way:
...
const StyledContent = styled(Popopover.Content, {
