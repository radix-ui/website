...
export default () => (
  <Popover>
    ...
    <PopoverContent sideOffset={3}>
      <Box css={{ width: 320 }}>
        <img src="https://images.unsplash.com/photo-1607622122464-5468eb3bc725?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2552&q=80" />
        <Box css={{ padding: 20 }}>
          <Text css={{ fontWeight: 500 }}>Woman in furcoat</Text>
          <Text css={{ margin: '5px 0 15px', color: 'slategray' }}>
            By Benn Mcguiness
          </Text>
          <Button css={{ width: '100%' }}>Follow</Button>
        </Box>
      </Box>
    </PopoverContent>
  </Popover>
...
These components are low-level enough, but the power is in your hands to choose how you want to wrap them. You're free to introduce your own high-level API to better suit your team's and product's needs.
