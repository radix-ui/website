...
Let's take a few minutes to install, style, and wrap a [Popover component](../components/popover).
...
```jsx
// App.tsx
import { Popover } from 'your-components/Popover';
...
export default () => (
  <Popover>
    ...
    <PopoverContent sideOffset={3} side="top">
      <Box css={{ width: 320 }}>
