      ...
      return [
        {
          ...
          destination: '/primitives/docs/overview/installation',
          permanent: false,
        },
        {
          source: '/primitives/docs/installation',
          destination: '/primitives/docs/overview/installation',
          permanent: false,
        },
        {
          source: '/design-system/docs',
          destination: '/design-system/docs/overview/installation',
          permanent: false,
        },
        {
          source: '/design-system/docs/installation',
          destination: '/design-system/docs/overview/installation',
          permanent: false,
        },
      ];
