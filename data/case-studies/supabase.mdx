...
companyAbout: Supabase is backend-as-a-service startup that automatically handles the behind-the-scenes work for developers.
...
The docs are amazing, we especially love the examples! Although the examples use a heavy amount of Stitches examples—something we don’t use in Supabase—it’s worth noting that you can style the primitives using whatever styling library you like. You’re never stuck with being forced on way or another.
