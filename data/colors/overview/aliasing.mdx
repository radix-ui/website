...
Each step in Radix Colors scales is designed for a specific use case. To help your developers know which step to use, you can provide aliases based on the designed use cases.
...
In these cases, you can choose to define multiple aliases which map to the same color.
...
Or you can simply recommend that developers defer to the original step number for cases where the use cases doesn't have an alias.
