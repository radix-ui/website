...
Radix Colors provides 20 color scales designed for white foreground text at step `9`.
...
Radix Colors provides 5 bright scales, designed for a dark foreground text at step `9`.
