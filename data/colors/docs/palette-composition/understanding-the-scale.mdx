...
<Flex wrap="wrap" gap="5" my="5">
  ...
  <Button icon={<PlusIcon />} variant="soft" color="red" />

{' '}

<Flex direction="column" style={{ maxWidth: 'max-content' }}>
  <MenuItemButton color="blue" data-state="active">
    Menu item
  </MenuItemButton>
  <MenuItemButton color="blue">Second menu item</MenuItemButton>
  <MenuItemButton color="blue">Third menu item</MenuItemButton>
</Flex>

  <Flex direction="column" style={{ maxWidth: 'max-content' }}>
    <MenuItemButton color="violet" data-state="active">
      Menu item
    </MenuItemButton>
    <MenuItemButton color="violet">
      Second menu item
    </MenuItemButton>
    <MenuItemButton color="violet">
      Third menu item
...
<Flex direction="column" mt="5" style={{ maxWidth: 250 }}>
  <MenuItemButton color="blue" data-state="highlighted">
    New unread email
  </MenuItemButton>
  <MenuItemButton color="blue" data-state="selected">
    Selected email
  </MenuItemButton>
  <MenuItemButton color="blue">Email menu item</MenuItemButton>
  <MenuItemButton color="blue">Email menu item</MenuItemButton>
</Flex>
...
<Flex gap="4" direction="column" my="5">
  ...
  <Text size="3" weight="bold" style={{ color: 'var(--blue-12)' }}>
