...
const theme = {
  ...
  graySolid: gray.gray8,
  grayPlaceholderText: gray.gray8,

  accentBorderHover: blue.blue7,
  accentFocusRing: blue.blue7,
};
...
:root {
  --graySolid: var(--gray8);
  --grayPlaceholderText: var(--gray8);

  --accentBorderHover: var(--blue7);
  --accentFocusRing: var(--blue7);
}
`}/>
    </TabsPanel>
</Tabs>
