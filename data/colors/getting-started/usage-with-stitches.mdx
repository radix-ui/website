---
metaTitle: Using Radix Colors with Stitches
metaDescription: How to use Radix Colors with Stitches.
---

# Using Radix Colors with Stitches

<Description>How to use Radix Colors with Stitches.</Description>
