...
- **Breaking** – Remove `IdProvider` and improve React 18 support for generated ids <PRLink id={1006} />
...
- **Breaking** – Add new `Portal` part that allows portalling into custom container <PRLink id={936} />
...
- **Breaking** – Improve React 18 support with new `TooltipProvider` part <PRLink id={1007} />
...
<PackageRelease name="AlertDialog" version="0.1.1" major />
