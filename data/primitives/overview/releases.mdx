...
- ✨ Improve polymorphic type performance <PRLink id={784} />
...
- 🔥 Remove `ContextMenu.Content` `disableOutsideScroll` prop <PRLink id={700} />
- 🔥 Remove `ContextMenu.Content` `disableOutsidePointerEvents` prop <PRLink id={700} />
- 🔥 Remove `ContextMenu.Content` `trapFocus` prop <PRLink id={700} />
- 🐛 Prevent outside pointer events triggering prematurely on touch devices <PRLink id={767} />

<PackageRelease name="Dialog" version="0.0.20" />

- ✨ Add Modality support via `modal` prop <PRLink id={700} />
- 🔥 Remove `Dialog.Content` `disableOutsideScroll` prop <PRLink id={700} />
- 🔥 Remove `Dialog.Content` `disableOutsidePointerEvents` prop <PRLink id={700} />
- 🔥 Remove `Dialog.Content` `trapFocus` prop <PRLink id={700} />
...
- 🐛 Prevent outside pointer events triggering prematurely on touch devices <PRLink id={767} />
- 🐛 Ensure inputs are consistently focused after open <PRLink id={776} />
...
- 🔥 Remove `DropdownMenu.Content` `trapFocus` prop <PRLink id={700} />
- 🐛 Prevent outside pointer events triggering prematurely on touch devices <PRLink id={767} />
