...
<PackageRelease name="Dropdown Menu" version="1.0.1" />
...
- [**Breaking**] Remove `useLabelContext` and support for fully custom controls. For native labelling to work, ensure your custom controls are based on native ones such as `button` or `input`. <PRLink id={1686} />
- Improve native behaviour by using the native `label` element <PRLink id={1686} />
