...
With this release, we start following semantic versioning stricly. All primitives are now versioned <Badge size="1" variant="blue" css={{ fontFamily: '$mono' }}>1.0.0</Badge>. [`Select`](../components/select), [`Toast`](../components/toast) and [`NavigationMenu`](../components/navigation-menu) also move out of beta.
