...
This release introduces 3 brand new primitives: `Select`, `Toast` and `NavigationMenu`, whilst also shipping a ton of fixes and improvements.
...
<PackageRelease name="Dialog" version="0.1.6" />

- Improve pointer-events management <PRLink id={1079} />
- Fix labelling issues when no `Description` is used <PRLink id={1098} />
