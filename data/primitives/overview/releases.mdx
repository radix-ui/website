...
- 🎉 All primitives moved to version <Badge size="1" variant="blue" css={{ fontFamily: '$mono' }}>0.1.1</Badge>
- 🐛 Fixed component context scoping to improve composing multiple primitives <PRLink id={906} />
- 🐛 Fixed CSS unmount animations <PRLink id={851} />
...
<PackageRelease name="Context Menu" version="0.1.0" />
...
<PackageRelease name="Hover Card" version="0.1.0" />
