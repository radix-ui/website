...
authorPosition: Core Collaborator at Node.js
...
<HeroQuote>
  Radix Primitives are crucial in our Node.js website, a significant part of
  Node’s Web Design System. It allows engineers to focus on what matters and
  create delightful experiences for our community.
</HeroQuote>

**Describe the type of project you are using Radix Primitives on?**

Radix Primitives are crucial in our Node.js website, a significant part of Node’s Web Design System. This integration allows us to effortlessly include standard UX primitives (Dropdowns, Dialogs, etc.) into our Node.js projects, enhancing the overall user experience.
...
In the end, Radix provides numerous patterns and built-in mechanisms that facilitate the day-to-day development of interactive UI elements. This allows engineers to focus on what matters and create delightful experiences for our community.
