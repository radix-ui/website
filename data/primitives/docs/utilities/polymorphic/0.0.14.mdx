...
<Callout.Root color="yellow" mt="-3">
  <Callout.Text>
    {[
      'This package has been deprecated in favour of the ',
      <Code variant="ghost">asChild</Code>,
      ' prop. Learn more about how to ',
      <Link href="/primitives/docs/guides/composition">
