...
Use the [`Slot` utility](/primitives/docs/utilities/slot) to convert the trigger part into a slottable area. It will replace the trigger with the child that gets passed to it.
