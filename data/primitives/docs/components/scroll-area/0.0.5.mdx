		...
		},
		{
			...
			description: (
				<span>
					...
					<br />
					<br />
					<Code>"always"</Code> means that scrollbars are always visible when
					content is overflowing on a given axis.
					<br />
					<Code>"scroll"</Code> means that scrollbars are visible when the user
					is scrolling along its corresponding axis.
					<br />
					<Code>"hover"</Code> when the user is scrolling along its
					corresponding axis and when the user is hovering over scrollable area.
				</span>
			),
		},
		{
