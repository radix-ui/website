...
<PropsTable
  data={[
    ...
    },
    {
      ...
      default: '"Toasts"',
      description:
        'Text used to label the viewport for assistive technologies.',
    },
  ]}
/>
...
An action that is safe to ignore. Toasts that require an action should use an [`AlertDialog`](/docs/primitives/components/alert-dialog) that is styled to look like a toast instead.
