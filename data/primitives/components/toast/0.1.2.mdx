  ...
  data={[
    {
      ...
      description: 'The vertically swipe gesture',
    },
    {
      cssVariable: '--radix-toast-swipe-move-y',
      description: 'The horizontally swipe gesture',
    },
    {
      cssVariable: '--radix-toast-swipe-end-x',
      description: 'When the vertically swipe gesture end',
    },
    {
      cssVariable: '--radix-toast-swipe-end-y',
      description: 'When the horizontally swipe gesture end',
    },
  ]}
/>
