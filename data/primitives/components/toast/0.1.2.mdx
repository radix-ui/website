  ...
  data={[
    {
      ...
      description: 'The vertical swipe current position',
    },
    {
      cssVariable: '--radix-toast-swipe-move-y',
      description: 'The horizontal swipe current position',
    },
    {
      cssVariable: '--radix-toast-swipe-end-x',
      description: 'The vertical swipe end position',
    },
    {
      cssVariable: '--radix-toast-swipe-end-y',
      description: 'The horizontal swipe end position',
    },
  ]}
/>
