...
An action that is safe to ignore. Toasts that require a response from the user should use an [`AlertDialog`](/docs/primitives/components/alert-dialog) that is styled to look like a toast instead.
