...
<PropsTable
  data={[
    ...
    },
    {
      ...
      typeSimple: 'function',
      description:
        'Event handler called when the value changes at the end of an interaction. This can be useful to avoid constantly syncing the value to a server while sliding.',
    },
    {
      name: 'name',
      required: false,
