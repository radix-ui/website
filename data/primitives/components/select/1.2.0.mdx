...
<PropsTable
  data={[
    ...
    },
    {
      ...
      description: (
        <span>
          The positioning mode to use. By default <Code>item-aligned</Code> will
          use some heuristics based on the items to position the content over
          the trigger trying to align it with the selected option at best
          (similar to what MacOS does). <Code>popper</Code> uses the same engine
          as all other components like <Code>Popover</Code> or{' '}
          <Code>DropdownMenu</Code> for example.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          enabled. Ignored when <Code>position</Code> isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          The distance in pixels from the anchor. Ignored when{' '}
          <Code>position</Code> isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          occur. Ignored when <Code>position</Code> isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          <Code>"end"</Code> alignment options. Ignored when{' '}
          <Code>position</Code> isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          Ignored when <Code>position</Code> isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          in this check. Ignored when <Code>position</Code> isn't{' '}
          <Code>popper</Code>.
        </span>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <span>
          ...
          overflowing the corners. Ignored when <Code>position</Code> isn't{' '}
          <Code>popper</Code>.
        </span>
      ),
    },
    {
      ...
      description: (
        <span>
          ...
          content in the boundary regardless. Ignored when <Code>position</Code>{' '}
          isn't <Code>popper</Code>.
        </span>
      ),
    },
    {
...
An optional arrow element to render alongside the content. This can be used to help visually link the trigger with the `Select.Content`. Must be rendered inside `Select.Content`. Ignored if `position` isn't `popper`.
...
By default (`position="item-aligned"`), will use some heuristics based on the items to position the content over the trigger trying to align it with the selected option at best (similar to what MacOS does). If you want the content to be positioned like `Popover` or `DropdownMenu` instead, use `position="popper"` on `Select.Content`.

In doing so, you can use any of the usual props to control alignment like `side`, `sideOffset`, etc.
...
When using `position="popper"` on `Select.Content`, you may want to constrain the width of the content so it matches the trigger width. You may also want to constrain its height so it doesn't exceed the viewport.

We expose a few CSS custom properties like `--radix-select-trigger-width` and `--radix-select-content-available-height`. Use them to constrain the content dimensions.
