...
<CssVariablesTable
  data={[
    {
      cssVariable: '--radix-scroll-area-corner-width',
      description: 'The width of the scrollbar when is visible/hidden',
    },
    {
      cssVariable: '--radix-scroll-area-corner-height',
      description: 'The height of the scrollbar when is visible/hidden',
    },
  ]}
/>
...
<CssVariablesTable
  data={[
    {
      cssVariable: '--radix-scroll-area-thumb-width',
      description: 'The width of the thumb when is visible/hidden',
    },
    {
      cssVariable: '--radix-scroll-area-thumb-height',
      description: 'The height of the thumb when is visible/hidden',
    },
  ]}
/>
