...
See [this example](/docs/primitives/components/navigation-menu#with-router-link-components) for more information on usage with third party routing components.
