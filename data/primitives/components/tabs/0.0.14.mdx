...
Contains the triggers aligned along the edge of the active content.
  ...
  data={[
    {
      ...
      description: (
        <span>
          When focus moves onto the tabs, focuses the active trigger.
          When a trigger is focused, moves focus to the active
          content.
        </span>
      ),
    },
    ...
    },
    {
      ...
      description: (
        <span>
          Moves focus to the first trigger and activates its
          associated content.
        </span>
      ),
    },
