...
Use Hover Card to preview information when the user hovers over an interactive element, saving them an extra click.
...
<Accordion type="single">
  ...
  <AccordionItem value="2">
    ...
    <AccordionContent>
      ...
      if all content items are alike, consider the [Dropdown
      Menu](dropdown-menu) component, which is specifically designed for
      building menus.
    </AccordionContent>
  </AccordionItem>
</Accordion>
