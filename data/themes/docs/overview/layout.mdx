...
Each layout component has a set of own specialized props and also a shared set of common layout props. All layout props support [responsive object values](/themes/docs/theme/breakpoints).
...
<ThemesPropsTable name="position" />
...
<ThemesPropsTable name="flexChildren" />
...
<ThemesPropsTable name="gridChildren" />
...
Explain how to use only layout components via layout.css
