...
We’ll present the main highlights in this post. The complete changelog is available on the [Radix website](/themes/docs/overview/releases#300).
...
Today, we are introducing a tool to create your own brand palette. It’s a simple interface that lets you specify a primary color, a gray color, and your page background, which then creates a color configuration to copy-paste into your theme styles.
...
<ThemesBlogPostExampleArea>
  <Box width="600px">
    <RadioCardGroup.Root defaultValue="1" columns="3">
...
<ThemesBlogPostExampleArea>
  <Box width="600px">
    <CheckboxCardGroup.Root defaultValue={['1']} columns="3">
      ...
      <CheckboxCardGroup.Item value="3">
        <Flex direction="column" width="100%">
