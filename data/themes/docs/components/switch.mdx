...
This component inherits the props from the [Radix Switch](/primitives/docs/components/switch) primitive and supports [common margin props](/themes/docs/theme/layout#margin-props).
