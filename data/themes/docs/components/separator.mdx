...
This component inherits the props from the [Radix Separator](/primitives/docs/components/separator) primitive and supports common margin props `m`, `mx`, `my`, `ml`, `mr`, `mt`, `mb`.
