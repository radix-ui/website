...
This component inherits props from the Radix ScrollArea [Root](/primitives/docs/components/scroll-area#root) and [Viewport](/primitives/docs/components/scroll-area#viewport) parts. It supports [common margin props](/themes/docs/theme/layout#margin-props).
