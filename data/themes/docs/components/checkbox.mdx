...
This component inherits the props from the [Radix Checkbox](/primitives/docs/components/checkbox) primitive and supports [common margin props](/themes/docs/theme/layout#margin-props).
