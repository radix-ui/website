...
<Grid align="center" columns="2" gap="5" p="3">
  <Flex direction="column">
    ...
    <Text color="gray" size="2">
      Learn how to create the perfect theme
    </Text>
  </Flex>
...
<Flex direction="column" gap="1">
  ...
  <Text color="violet">The quick brown fox jumps over the lazy dog.</Text>
  <Text color="grass">The quick brown fox jumps over the lazy dog.</Text>
