...
If you already have an icon inside the button, you can use the `disabled` state and a [Spinner](/themes/docs/components/spinner) component to achieve a more streamlined design.
