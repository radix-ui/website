...
Use the `loading` prop to control whether spinner or its children are displayed. Spinner preserves the original dimensions of its children when they are hidden.
