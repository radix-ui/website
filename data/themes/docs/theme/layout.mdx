...
Margin props are shorthand utilities for applying margin to any side of an element, they are useful when you need to apply space between individual elements. Margin props are exposed on all components that return a node.
