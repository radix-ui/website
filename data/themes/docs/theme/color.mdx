...
Out of the box Radix Themes provides 28, 12 step color scales, each with its own light, dark and alpha variants.
...
Every color has an alpha variant which is designed to appear visually the same when placed over a matching background. This is very powerful and allows colors to be overlayed without a loss of saturation or hue.
