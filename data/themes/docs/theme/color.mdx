...
The accent is the most dominant color in your theme, it is used for primary buttons, links and other interactive elements. The accent can be one of [26 scales](/themes/docs/theme/color#choosing-an-accent-color).
...
There are 26 accents to choose from.

21 scales designed for light foreground text.
