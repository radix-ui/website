...
/* Tinted panel background in dark mode */
var(--gray-2-translucent);
```
    ...
    <Callout.Root>
      ...
      <Callout.Text>
        <Flex as="span" align="center" gap="4">
          <Text>This branch has new commits.</Text>
          <Button size="1" my="-2">
            Refresh
          </Button>
        </Flex>
...
<Theme accentColor="indigo">
  <Flex direction="column" gap="4">
    <Text>
      Complete your account setup in <Link>settings</Link>
    </Text>
    <Text color="gray">
      Complete your account setup in <Link>settings</Link>
    </Text>
...
Radix Themes colors can be customized by overriding the corresponding variables of the CSS token system. Refer to the [source code](https://github.com/radix-ui/themes/blob/main/packages/radix-ui-themes/src/styles/tokens/color.css) for the full list of the color tokens.
