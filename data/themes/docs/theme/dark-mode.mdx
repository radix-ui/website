...
<Callout.Root my="5">
  ...
  <Callout.Text>
    ...
    <Code>appearance</Code>, instead relying wholly on class switching. This is important
    as <Code>next-themes</Code> will automatically prevent any unsightly flashing
