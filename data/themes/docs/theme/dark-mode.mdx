...
Dark mode has gained widespread popularity in recent years, with operating systems now offering comprehensive support for it directly within the OS.

Out of the box, Radix Themes comes with a built in dark mode option, allowing you to effortlessly switch between modes without any additional design or styling.

{

<Box my="5">
  <Card size="3">Light and dark example</Card>
</Box>
