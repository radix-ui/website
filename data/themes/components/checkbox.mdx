...
This component inherits the props from the [Radix Checkbox](/primitives/docs/components/checkbox) primitive and supports common margin props `m`, `mx`, `my`, `ml`, `mr`, `mt`, `mb`.
