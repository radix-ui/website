...
This component inherits parts and props from the [Radix Alert Dialog](/primitives/docs/components/alert-dialog) primitive and is visually identical to [Dialog](./dialog), though with differing semantics and behavior. [View source](https://github.com/workos/workos/blob/main/packages/design-system/src/components/alert-dialog.tsx)
