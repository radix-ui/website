---
metaTitle: Text
metaDescription: Displays a basic text primitive.
---
...
<ThemesPropsTable
  data={({ text }) => [
    ...
    },
    {
      name: 'weight',
      required: false,
      type: text.weight.values,
      default: text.weight.default,
      typeSimple: 'enum',
    },
    {
      name: 'align',
      required: false,
      type: text.align.values,
    ...
    },
    {
      name: 'trim',
      required: false,
      type: text.trim.values,
      default: text.trim.default,
      typeSimple: 'enum',
    },
    {
      name: 'color',
...
Use the `asChild` prop to render text as a `div` or `span`. This prop is purely semantic and does not change the visual appearance of the text.
