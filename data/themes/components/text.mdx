...
<ThemesPropsTable
  data={(variables) => [
    ...
    },
    {
      name: 'size',
      required: false,
      type: variables.text.size.values,
      default: variables.text.size.default,
      typeSimple: 'enum',
    },
    {
      name: 'weight',
      required: false,
      type: variables.text.weight.values,
      default: variables.text.weight.default,
      typeSimple: 'enum',
    },
    {
      name: 'align',
      required: false,
      type: variables.text.align.values,
      default: variables.text.align.default,
      typeSimple: 'enum',
    },
    {
      name: 'trim',
      required: false,
      type: variables.text.trim.values,
      default: variables.text.trim.default,
      typeSimple: 'enum',
    },
    {
      name: 'color',
      required: false,
      typeSimple: 'enum',
      default: variables.text.color.default,
      description: (
        <>
...
<Text size="5">
  ...
  <Em>italic emphasis</Em>, a piece of computer <Code>code</Code>, and even a hotkey
  combination <Kbd>⇧⌘A</Kbd> within the text.
  <Sup>1</Sup>
</Text>
```
