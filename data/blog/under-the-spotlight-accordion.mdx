...
With roving focus, you can press `ArrowLeft`/`ArrowRight` to move focus across the Accordion Buttons. This allows the focus to loop. Pressing `Tab` will move the focus to the Accordion Panel.
