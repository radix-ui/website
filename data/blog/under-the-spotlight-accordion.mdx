...
The Radix Accordion offers common configuration options via props.

For example, you can configure it to allow multiple panels to be opened at the same time. Or you can configure it to always keep at least one panel opened, whilst adhering to the accessibility spec.
